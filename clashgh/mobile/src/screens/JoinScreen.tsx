...
import { Badge, Button, FadeIn, GameTile, Screen, TextField } from '../components/ui';
      ...
      <Screen style={{ padding: 0 }}>
        <ScrollView contentContainerStyle={{ padding: spacing.xl, gap: spacing.lg }}>
          ...
          <View style={[styles.card, { padding: 0, overflow: 'hidden' }]}>
            {tournament ? (
              <>
                <View style={{ flexDirection: 'row', gap: spacing.md, alignItems: 'center', padding: spacing.lg, paddingBottom: 0 }}>
                  <GameTile code={GAMES[tournament.game].code} accent={GAMES[tournament.game].accent} size={44} />
                  <View style={{ flex: 1, gap: 2 }}>
                    <View style={{ flexDirection: 'row', gap: spacing.sm, alignItems: 'center' }}>
                      <Text style={{ color: colors.textMuted, fontSize: typography.tiny, fontWeight: fontWeights.semibold, letterSpacing: 0.6, textTransform: 'uppercase' }}>{GAMES[tournament.game].label}</Text>
          ...
          {step === 'paid' ? (
            <FadeIn style={{ gap: spacing.md, alignItems: 'center', paddingVertical: spacing.xl }}>
              ...
              <Text style={[styles.stepTitle, { fontSize: typography.title }]}>You're in</Text>
...
const styles = StyleSheet.create({
  ...
  title: { color: colors.text, fontSize: typography.subheading, fontWeight: fontWeights.semibold },
